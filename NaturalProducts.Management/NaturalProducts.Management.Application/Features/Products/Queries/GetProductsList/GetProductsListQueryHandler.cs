...
{
    public class GetProductsListQueryHandler : IRequestHandler<GetProuctsListQuery, List<ProductListVm>>
    {
        ...
        public async Task<List<ProductListVm>> Handle(GetProuctsListQuery request,
